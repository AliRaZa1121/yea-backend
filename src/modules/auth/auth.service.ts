...
export default class AuthService {
    ...
    async forgetPassword(
        ...
        return successApiWrapper(null, `Password reset link sent successfully`, HttpStatus.OK);
    }
    ...
    private async createAccessTokenRefreshTokenPair(
        ...
        await this._redisCacheService.Set(userTokensKey, userTokens, USER_TOKENS_CACHE_EXPIRY);
